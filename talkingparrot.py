...
def handle_api_request(json_response):
    ...
    if module == "Weather":
    ...
    elif module == "GeminiModule":
        print("Im at GEMINI MODULEEE")
        ...
        print("Im at ENDD GEMINI MODULEEE")
        gemres=response.text
        return {"GeminiModule": gemres}
        ...
        if action.lower() == "open":
            ...
            response = {"module": "VoiceControl", "parameters": parameters, "parameter_count": len(parameters),
                        "success": True, "description": f"Opening {device_name}."}
            ...
            response = {"module": "VoiceControl", "parameters": parameters, "parameter_count": len(parameters),
                        "success": True, "description": f"Closing {device_name}."}
...
def main():
    ...
    engine.say("Hey, I am your Indian Servers BOT. How can I assist you today?")
    engine.runAndWait()
    ...
    while True:
        ...
        if "good evening" in user_input.lower():
            engine.say("Good evening! Work like a soldier!")
            engine.runAndWait()
            continue
            ...
            if extracted_json_string:
                ...
                try:
                    ...
                    if isinstance(api_response, dict):
                        ...
                        elif "GeminiModule" in api_response:
                            engine.say(api_response["GeminiModule"])
